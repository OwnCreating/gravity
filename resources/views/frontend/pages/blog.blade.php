                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="blog-item">
                                <img src="{{asset('frontend/images/test_img/1.jpg')}}" alt="">
                                <div class="blog-desc">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="blog-item">
                                <img src="{{asset('frontend/images/test_img/2.jpg')}}" alt="">
                                <div class="blog-desc">
                                    <h5 class="blog-title"><a href="single-blog.html">dummy Blog name</a></h5>
                                    <p>There are many variations of passages of psum available, but the majority have suffered alterat on in some form, by injected humour, randomis words which don't look even slightly.</p>
                                    <div class="read-more">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="blog-item">
                                <img src="{{asset('frontend/images/test_img/3.jpg')}}" alt="">
                                <div class="blog-desc">
                                    <h5 class="blog-title"><a href="single-blog.html">dummy Blog name</a></h5>
                                    <p>There are many variations of passages of psum available, but the majority have suffered alterat on in some form, by injected humour, randomis words which don't look even slightly.</p>
                                    <div class="read-more">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="blog-item">
                                <img src="{{asset('frontend/images/test_img/4.jpg')}}" alt="">
                                <div class="blog-desc">
                                    <h5 class="blog-title"><a href="single-blog.html">dummy Blog name</a></h5>
                                    <p>There are many variations of passages of psum available, but the majority have suffered alterat on in some form, by injected humour, randomis words which don't look even slightly.</p>
                                    <div class="read-more">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="blog-item">
                                <img src="{{asset('frontend/images/test_img/5.jpg')}}" alt="">
                                <div class="blog-desc">
                                    <h5 class="blog-title"><a href="single-blog.html">dummy Blog name</a></h5>
                                    <p>There are many variations of passages of psum available, but the majority have suffered alterat on in some form, by injected humour, randomis words which don't look even slightly.</p>
                                    <div class="read-more">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="blog-item">
                                <img src="{{asset('frontend/images/test_img/6.jpg')}}" alt="">
                                <div class="blog-desc">
                                    <h5 class="blog-title"><a href="single-blog.html">dummy Blog name</a></h5>
                                    <p>There are many variations of passages of psum available, but the majority have suffered alterat on in some form, by injected humour, randomis words which don't look even slightly.</p>
                                    <div class="read-more">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="blog-item">
                                <img src="{{asset('frontend/images/test_img/7.jpg')}}" alt="">
                                <div class="blog-desc">
                                    <h5 class="blog-title"><a href="single-blog.html">dummy Blog name</a></h5>
                                    <p>There are many variations of passages of psum available, but the majority have suffered alterat on in some form, by injected humour, randomis words which don't look even slightly.</p>
                                    <div class="read-more">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="blog-item">
                                <img src="{{asset('frontend/images/test_img/8.jpg')}}" alt="">
                                <div class="blog-desc">
                                    <h5 class="blog-title"><a href="single-blog.html">dummy Blog name</a></h5>
                                    <p>There are many variations of passages of psum available, but the majority have suffered alterat on in some form, by injected humour, randomis words which don't look even slightly.</p>
                                    <div class="read-more">
