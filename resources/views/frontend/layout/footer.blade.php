                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="copyright-text">
                                        <p>&copy; <a href="#" target="_blank">Made By CodeX</a> 2019. All Rights Reserved.</p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <ul class="footer-payment text-right">
                                        <li>
                                            <a href="https://www.myanmarpaymentunion.com" target="_blank">We Accept with

                                                <img src="{{asset('frontend/images/test_img/mpu.png')}}" alt="">
                                            </a>
                                        </li>
                                    </ul>
                                </div>
