<div class="scroll-sidebar">
    ...
    <div class="user-profile">
        <!-- User profile image -->
        <div class="profile-img"> <img src="{{asset('../back/assets/images/users/profile.png')}}" alt="user" />
    ...
    <nav class="sidebar-nav">
        <ul id="sidebarnav">
            ...
            <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                        class="mdi mdi-gauge"></i><span class="hide-menu">Role </span></a>
                <ul aria-expanded="false" class="collapse">
                    <li><a href="{{route('assign.index')}}">User Table</a></li>
                </ul>
            </li>
            <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
            ...
            <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                        class="mdi mdi-gauge"></i><span class="hide-menu">Authenication </span></a>
                <ul aria-expanded="false" class="collapse">
